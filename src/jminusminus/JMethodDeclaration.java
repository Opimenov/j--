...
class JMethodDeclaration
    ...
    /** Exceptions list. */
    protected ArrayList<Type> exceptionsList;
    ...
    public JMethodDeclaration(int line, ArrayList<String> mods,
        String name, Type returnType,
			      ArrayList<JFormalParameter> params,   JBlock body, ArrayList<Type> exceptionsList)
    {
        super(line);
        this.mods = mods;
        this.name = name;
    ...
    public void writeToStdOut(PrettyPrinter p) {
        ...
        if (exceptionsList != null && !exceptionsList.isEmpty()) {
            p.println("<ExceptionsList>");
            for (Type t : exceptionsList) {
                p.indentRight();
