...
class JavaCCParser implements JavaCCParserConstants {
  ...
  final private JAST typeDeclaration() throws ParseException {
    ...
    try {
      ...
      {if (true) return typeDeclaration;}
    throw new Error("Missing return statement in function");
  }
    ...
    try {
      ...
      case IMPLEMENTS:
        ...
        superInterface = qualifiedIdentifier();
              interFaceList = new ArrayList<Type>();
              interFaceList.add(superInterface);
        label_5:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case COMMA:
      ...
      classBody = classBody();
        ...
        {if (true) return new JClassDeclaration( line, mods,
                                      name, superClass, classBody, interFaceList );}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JInterfaceDeclaration interfaceDeclaration(ArrayList<String> mods) throws ParseException {
    ...
    String name = "";
    Type superInterface = null;
    ArrayList<Type>  superInterfaceList= new ArrayList<Type>();
    ArrayList<JMember> interfaceBody = null;
    try {
            if ( mods != null && !mods.isEmpty()) {
                for (String st : mods) {
                    if (st.equals("final")) {
                        {if (true) throw new ParseException("interface cannot be final");}
                    }
                }
            }
      ...
      interfaceBody = interfaceBody();
        ...
        {if (true) return new JInterfaceDeclaration( line, mods,
            name, superInterfaceList, interfaceBody );}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JMember interfaceMemberDecl(ArrayList<String>  mods) throws ParseException {
    ...
    ArrayList<Type> exceptionsList = null;
    Type someException = null;
    ...
    try {
      if (jj_2_2(2147483647)) {
        ...
        case THROWS:
          ...
          someException = qualifiedIdentifier();
                     exceptionsList = new ArrayList<Type>();
                     exceptionsList.add(someException);
          label_10:
          while (true) {
            switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
            case COMMA:
        ...
        jj_consume_token(SEMI);
                memberDecl =
                new JMethodDeclaration( line, mods, name, type, params, null, exceptionsList );
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case BOOLEAN:
        case CHAR:
        ...
        case IDENTIFIER:
          ...
          variableDeclarators = variableDeclarators(type);
               if(!variableDeclarators.isEmpty()) {
                    for (JVariableDeclarator vd : variableDeclarators) {
                        if (vd.initializer() == null) {
                            reportParserError("ERROR   >>>  Uninitialized field inside interface body", variableDeclarators);
  ...
  final private JMember memberDecl(ArrayList<String>  mods) throws ParseException {
    ...
    try {
      if (jj_2_3(2147483647)) {
        ...
        body = block();
                memberDecl =
                new JConstructorDeclaration( line, mods, name, params, body, exceptionsList );
        ...
        default:
          ...
          throw new ParseException();
                ...
                memberDecl =
                   new JMethodDeclaration( line, mods, name, type, params, body, exceptionsList );
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case BOOLEAN:
        case CHAR:
    ...
    try {
      ...
      case FOR:
        ...
        if (jj_2_7(2147483647)) {
          ...
          body = statement();
           statement = new JForEnhancedStatement(line, mType, id, expr, body);
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case BOOLEAN:
          case CHAR:
          ...
          case STRING_LITERAL:
            ...
            jj_consume_token(RPAREN);
            body = statement();
             statement = new JForRegularStatement(line,
                             initFor, expr, updateFor, body);
            break;
          default:
            jj_la1[32] = jj_gen;
            jj_consume_token(-1);
  ...
  final private JForInit forInit() throws ParseException {
    JStatement decl = null;
    int line = 0;
    Type mType = null;
    ArrayList<JVariableDeclarator> vars = null;
    ...
    try {
      ...
      if (jj_2_8(2147483647)) {
        ...
        mType = type();
        vars = variableDeclarators(mType);
               forInit =  new JForInit( line, stms, mType, vars) ;
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case FALSE:
        case NEW:
  ...
  final private JForUpdate forUpdate() throws ParseException {
    JStatement ex = null;
    int line = 0;
      ...
      while (true) {
        ...
        ex = statementExpression();
         updates.add(ex);
          ...
          forUpdate = new JForUpdate(line, updates);
    } catch (ParseException e) {
        recoverFromError( new int[] { SEMI, EOF }, e );
    }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x2000000,0x40000,0x5c004480,0x0,0x0,0x5c004080,0x5c004080,0x2000,0x0,0x80000,0x0,0x2000,0x5c214b80,0x5c214b80,0x5c214b80,0x210b00,0x0,0x0,0x0,0x210b00,0x0,0x0,0x210b00,0x0,0x0,0x0,0x210b00,0xa1e38b00,0xa1c28000,0x8161cb00,0x81408000,0x81408000,0x8161cb00,0x81408000,0xa1c28000,0x0,0x210b00,0x4000,0x0,0x81408000,0x0,0x0,0x0,0x81408000,0x0,0x81408000,0x0,0x81408000,0x210b00,0x210b00,0x0,0x0,0x210b00,0x0,0x0,0x0,0x0,0x100000,0x100000,0x0,0x0,0x0,0x81408000,0x0,0x81408000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x81408000,0x210b00,0x0,0x0,0x0,0x1008000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x20,0x8000000,0x20,0x0,0x0,0x0,0x4000000,0x0,0x4000000,0x0,0x10000008,0x11000008,0x11000008,0x10000008,0x400000,0x4000000,0x4,0x10000000,0x4000000,0x4,0x10000008,0x4000000,0x4,0x1100000,0x10000000,0x1114c813,0x1114c813,0x1004c803,0x1004c803,0x1004c803,0x1104c803,0x1004c803,0x1114c813,0x4000000,0x10000000,0x0,0x4000000,0x1004c803,0x4000000,0x4000000,0x80,0x1014c803,0x4000000,0x1014c803,0x4000000,0x1004c803,0x0,0x0,0x400000,0x400000,0x10000000,0x10080,0x10080,0x1000,0x200,0x2400,0x2400,0x8040,0x8040,0x20000,0x1004c803,0x4000,0x10040003,0x8400000,0x100,0x40000,0x8400000,0x40000,0x40000,0x8040000,0x40000,0x10040003,0x10000000,0x100000,0x40000,0x400000,0x2,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4780,0x4780,0x4780,0x4780,0x4780,0x4780,0x4780,0x4780,0x0,0x0,0x0,0x0,0x4780,0x0,0x0,0x0,0x4780,0x0,0x4780,0x0,0x4780,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4780,0x0,0x4780,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4780,0x0,0x0,0x0,0x0,0x4780,};
   }
