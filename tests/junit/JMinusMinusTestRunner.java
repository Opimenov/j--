...
/*        suite.addTestSuite(HelloWorldTest.class);
 ...
 //       suite.addTestSuite(BitANDTest.class); // AND
 //       suite.addTestSuite(BitORTest.class);  // OR
 //       suite.addTestSuite(BitXORTest.class); // XOR
//	suite.addTestSuite(MlineComTest.class); // multiline comment ignore
